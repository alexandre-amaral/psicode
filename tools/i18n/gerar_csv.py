...
UI = [
    ...
    # inventario (TAB) e troca de arma
    ("INVENTÁRIO", "INVENTORY"),
    ("[TAB] FECHAR", "[TAB] CLOSE"),
    ("ARMAMENTO", "ARMAMENT"),
    ("DIAGNÓSTICO", "DIAGNOSTICS"),
    ("[F] ALTERNAR", "[F] SWAP"),
    ("VAGA LIVRE", "SLOT FREE"),
    ("ATIVA", "ACTIVE"),
    # as tres abas
    ("ITENS", "ITEMS"),
    ("STATUS", "STATUS"),
    ...
    ("NENHUM SISTEMA INSTALADO", "NO SYSTEMS INSTALLED"),
    # linhas do diagnostico. DANO, CADENCIA, PRECISAO e ALCANCE ja estao acima,
    # vindos do cartao de selecao -- os mesmos quatro atributos, a mesma chave.
    ("INTEGRIDADE", "INTEGRITY"),
    ("DANO (SOMA)", "DAMAGE (FLAT)"),
    ("DANO (FATOR)", "DAMAGE (MULT)"),
    ("MOVIMENTO", "MOVEMENT"),
    ("ROLAMENTO", "DODGE ROLL"),
    ("DETERIORAÇÃO", "DETERIORATION"),
    ("RICOCHETE", "RICOCHET"),
    ("FRAGMENTAÇÃO", "FRAGMENTATION"),
    # tela de troca de arma
    ("NOVA ARMA", "NEW WEAPON"),
    ("SUBSTITUIR:", "REPLACE:"),
    ("[1] [2] ESCOLHER", "[1] [2] CHOOSE"),
    ("[ESC] CANCELAR", "[ESC] CANCEL"),
    ("VAZIO", "EMPTY"),
    # tags de comportamento de arma
    ("FANTASMA", "PHASE"),
    ("GRAVIDADE", "GRAVITY"),
    ("EXPLOSIVO", "EXPLOSIVE"),
    ("PLASMA", "PLASMA"),
